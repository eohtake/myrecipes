...
class RecipeTest < ActiveSupport::TestCase
  def setup
    @chef = Chef.create( chefname: "Eric Ohtake", email: "ericohtake@outlook.com" )
    @recipe = @chef.recipes.new( name: "Lasanha de queijo", summary: "A melhor lasanha de Guarulhos",
